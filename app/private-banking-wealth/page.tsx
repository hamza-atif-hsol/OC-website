...
export default function PrivateBankingWealthPage() {
    const { t } = useLanguage()
    ...
    const breadcrumbText = "Homepage / Segments / Private Banking & Wealth Management"

    const heroTitleLines = ["Private Banking", "& Wealth Management"]

    const heroDescription =
        "One Constellation empowers private banks and wealth managers to deliver exceptional, personalized client experiences while maintaining enterprise-grade compliance and operational efficiency."

    const heroBullets: string[] = [
        "Personalized client journey orchestration for high-net-worth individuals.",
        "Streamlined wealth account opening and portfolio management workflows.",
        "Advanced compliance controls for complex family office and trust structures.",
    ]

    const helps: HelpItem[] = [
        {
            icon: ShieldCheck,
            title: "Elevated client relationship management",
            desc:
                "Manage sophisticated client relationships with personalized journeys, centralized data, and seamless collaboration across private banking teams.",
        },
        {
            icon: Timer,
            title: "Rapid wealth account activation",
            desc:
                "Accelerate wealth account opening and portfolio setup with guided workflows and automated document collection.",
        },
        {
            icon: Workflow,
            title: "Sophisticated compliance orchestration",
            desc:
                "Automate complex compliance workflows for high-net-worth clients, family offices, and trust structures across multiple jurisdictions.",
        },
    ]
    ...
    const insights = React.useMemo(
        () => [
            {
                title: "Elevating wealthy client experiences",
                desc: "How leading private banks reduce onboarding friction and enhance relationship quality.",
                href: "/resources/insights/private-banking",
            },
            {
                title: "Managing complex family office compliance",
                desc: "Navigating regulatory requirements across multiple jurisdictions for high-net-worth structures.",
                href: "/resources/insights/family-office",
            },
        ],
        []
    )
    ...
    const demoPoints: string[] = [
        "Deliver exceptional wealthy client experiences",
        "Streamline complex account opening and activation",
        "Strengthen compliance across family office structures",
        "Build deeper client relationships and loyalty",
    ]

    const testimonialQuote =
        "One Constellation transformed how we serve high-net-worth clients enabling faster onboarding, better relationship management, and stronger compliance across our global private banking operations."

    const testimonialAttribution = "  Head of Private Banking, Global Wealth Manager"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="relative rounded-3xl overflow-hidden border border-slate-200 bg-slate-50 shadow-sm">
                                <img src="/segment-cib.png" alt="Private Banking" className="w-full h-auto object-contain" />
                            </div>
                            ...
                            <div className="hidden md:block absolute -left-6 bottom-10 rounded-2xl bg-white shadow-lg border border-slate-200 p-4 w-[260px]">
                                ...
                                <p className="text-sm text-slate-600 mt-2">
                                    Orchestrate sophisticated client relationships with centralized workflows and compliance controls.
                                </p>
                            </div>
                        </motion.div>
                    </div>
                ...
                <div className="container mx-auto px-4">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className=" mx-auto">
                        <motion.h2 variants={fadeInUp} className="text-3xl md:text-4xl font-semibold text-slate-900">
                            How One Constellation Helps Private Banks
                        </motion.h2>
                ...
                <div className="container mx-auto px-4">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className=" mx-auto">
                        ...
                        <motion.p variants={fadeInUp} className="text-white/70 mt-4 max-w-3xl">
                            We partner with market-leading providers to help you implement faster and deliver best-in-class wealth management solutions.
                        </motion.p>
