...
export default function RetailBankingPage() {
  ...
  const breadcrumbText = "Homepage / Segments / Retail Banking"

  const heroTitleLines = ["Retail", "Banking"]

  const heroDescription =
    "One Constellation enables retail banks to scale customer acquisition, streamline account opening, and enhance compliance while delivering seamless digital experiences."

  const heroBullets: string[] = [
    "Digital-first account opening with guided journeys and instant verification.",
    "Scalable customer lifecycle management across all retail banking products.",
    "Automated compliance controls that adapt to customer risk profiles.",
  ]
  ...
  const helps: HelpItem[] = [
    {
      ...
      desc:
        "Enable customers to open accounts in minutes with guided workflows, mobile-first design, and real-time document verification.",
    },
    {
      icon: Timer,
      title: "Rapid time-to-market",
      desc:
        "Launch new retail products faster with reusable journey templates and automated approvals.",
    },
    {
      icon: Workflow,
      title: "Compliance at scale",
      desc:
        "Maintain consistent compliance across high-volume retail onboarding with automated controls and real-time risk scoring.",
    },
  ]
  ...
  const insights = React.useMemo(
    () => [
      {
        title: "Digital-first retail banking strategies",
        desc: "How leading banks reduce onboarding drop-off rates and improve customer conversion.",
        href: "/resources/insights/retail-banking",
      },
      {
        title: "Compliance automation for scale",
        desc: "Managing regulatory requirements at scale without slowing down customer acquisition.",
        href: "/resources/insights/compliance-scale",
      },
    ],
    []
  )
  ...
  const demoPoints: string[] = [
    "Accelerate customer acquisition at scale",
    "Reduce onboarding friction and abandonment",
    "Strengthen compliance with automation",
    "Launch products faster to market",
  ]

  const testimonialQuote =
    "One Constellation transformed our retail onboarding enabling 10x faster customer acquisitions while maintaining strong compliance controls and improving conversion rates across all channels."

  const testimonialAttribution = "  Head of Digital Banking, Leading Retail Bank"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative rounded-3xl overflow-hidden border border-slate-200 bg-slate-50 shadow-sm">
                <img src="/segment-cib.png" alt="Retail Banking" className="w-full h-auto object-contain" />
              </div>
              ...
              <div className="hidden md:block absolute -left-6 bottom-10 rounded-2xl bg-white shadow-lg border border-slate-200 p-4 w-[260px]">
                ...
                <p className="text-sm text-slate-600 mt-2">
                  Deliver seamless onboarding experiences that convert customers and maintain compliance.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className=" mx-auto">
            <motion.h2 variants={fadeInUp} className="text-3xl md:text-4xl font-semibold text-slate-900">
              How One Constellation Helps Retail Banks
            </motion.h2>
        ...
        <div className="container mx-auto px-4">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className=" mx-auto">
            ...
            <motion.p variants={fadeInUp} className="text-white/70 mt-4 max-w-3xl">
              We partner with market-leading providers to help you implement faster and deliver best-in-class retail banking experiences.
            </motion.p>
