...
export default function CLMAssetServicesPage() {
    const { t } = useLanguage()
    ...
    const breadcrumbText = "Homepage / Segments / CLM for Asset Services"

    const heroTitleLines = ["CLM for", "Asset Services"]

    const heroDescription =
        "One Constellation enables asset service providers to streamline client lifecycle management, enhance operational efficiency, and deliver exceptional experiences across asset servicing operations."

    const heroBullets: string[] = [
        "End-to-end client lifecycle orchestration from onboarding to offboarding.",
        "Unified platform for asset servicing workflows and document management.",
        "Automated compliance and regulatory controls for asset service providers.",
    ]

    const helps: HelpItem[] = [
        {
            icon: ShieldCheck,
            title: "Comprehensive asset client management",
            desc:
                "Manage every aspect of asset client relationships through a single, integrated platform that connects all teams and operational touchpoints.",
        },
        {
            icon: Timer,
            title: "Accelerated client onboarding",
            desc:
                "Streamline asset service client onboarding with automated workflows, structured data capture, and rapid approvals.",
        },
        {
            icon: Workflow,
            title: "Operational excellence",
            desc:
                "Optimize asset servicing processes with centralized document management, automated controls, and real-time visibility.",
        },
    ]
    ...
    const insights = React.useMemo(
        () => [
            {
                title: "Optimizing asset service operations",
                desc: "How leading providers reduce manual work and improve client servicing speed.",
                href: "/resources/insights/asset-services",
            },
            {
                title: "Compliance in complex asset environments",
                desc: "Managing regulatory requirements across multiple jurisdictions and asset classes.",
                href: "/resources/insights/asset-compliance",
            },
        ],
        []
    )
    ...
    const demoPoints: string[] = [
        "Streamline asset service client management",
        "Accelerate onboarding and reduce operational friction",
        "Strengthen compliance and audit capabilities",
        "Enhance client satisfaction and retention",
    ]

    const testimonialQuote =
        "One Constellation transformed our asset servicing operations enabling faster client onboarding and stronger compliance controls across all jurisdictions."

    const testimonialAttribution = "  Head of Operations, Global Asset Service Provider"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="relative rounded-3xl overflow-hidden border border-slate-200 bg-slate-50 shadow-sm">
                                <img src="/segment-cib.png" alt="Asset Services" className="w-full h-auto object-contain" />
                            </div>
                            ...
                            <div className="hidden md:block absolute -left-6 bottom-10 rounded-2xl bg-white shadow-lg border border-slate-200 p-4 w-[260px]">
                                <div className="flex items-center gap-2 text-slate-900 font-semibold">
                                    ...
                                    Unified asset servicing
                                </div>
                                <p className="text-sm text-slate-600 mt-2">
                                    Manage complex asset service client journeys with centralized workflows and automated controls.
                                </p>
                            </div>
                        </motion.div>
                    </div>
                ...
                <div className="container mx-auto px-4">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className=" mx-auto">
                        <motion.h2 variants={fadeInUp} className="text-3xl md:text-4xl font-semibold text-slate-900">
                            How One Constellation Helps Asset Service Providers
                        </motion.h2>
                ...
                <div className="container mx-auto px-4">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className=" mx-auto">
                        ...
                        <motion.p variants={fadeInUp} className="text-white/70 mt-4 max-w-3xl">
                            We partner with market-leading providers to help you implement faster and deliver comprehensive asset servicing solutions.
                        </motion.p>
