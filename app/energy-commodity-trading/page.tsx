    ...
    const helps: HelpItem[] = [
        {
            ...
            desc:
                "Manage complex counterparty onboarding and relationship lifecycle with centralized workflows, document management, and approval routing.",
        },
        {
            icon: Timer,
            title: "Rapid market entry",
            desc:
                "Accelerate new counterparty activation and trading relationships with automated KYC and compliance workflows.",
        },
        {
            icon: Workflow,
            title: "Trading compliance at scale",
            desc:
                "Maintain consistent transaction monitoring and financial crime controls across all trading activities and counterparties.",
        },
    ]
