...
export default function CommercialBankingPage() {
  ...
  // ✅ Content updated (rephrased from your reference page)
  const breadcrumbText = "Homepage / Segments / Commercial Banking"

  const heroTitleLines = ["Commercial", "Banking"]

  const heroDescription =
    "One Constellation helps commercial banks modernize onboarding and servicing with digital journeys that boost operational efficiency and elevate the client experience."

  const heroBullets: string[] = [
    "Optimized client journeys across onboarding and servicing.",
    "Frictionless digital experiences that reduce handoffs and delays.",
    "Automated financial crime and regulatory compliance controls.",
  ]

  const helps: HelpItem[] = [
    {
      icon: ShieldCheck,
      title: "Digital end-to-end client experience",
      desc:
        "Connect front-, middle-, and back-office teams through one controlled journey reducing manual touchpoints and improving consistency.",
    },
    {
      icon: Timer,
      title: "Streamlined account opening",
      desc:
        "Automate product requests and account opening steps to remove bottlenecks and get clients live faster.",
    },
    {
      icon: Workflow,
      title: "Single client view",
      desc:
        "Create a unified view of clients, data, and documents across the organization improving accuracy and reducing rework.",
    },
  ]
  ...
  const insights = React.useMemo(
    () => [
      {
        title: "Commercial onboarding: reducing friction at scale",
        desc: "Practical ways to cut handoffs, reduce rework, and improve time-to-onboard without weakening controls.",
        href: "/resources/insights/commercial-onboarding",
      },
      {
        title: "Standardize controls across regions",
        desc: "How to keep policies consistent while supporting local requirements and operational differences.",
        href: "/resources/insights/policy-controls",
      },
      {
        title: "Agentic AI for operations and compliance",
        desc: "Where intelligent agents can safely automate repeatable work with governance built in.",
  ...
  const testimonialQuote =
    "“We adopted One Constellation to support a global transformation simplifying our processes and improving the way we engage clients, while strengthening compliance and onboarding outcomes.”"

  const testimonialAttribution = "  Global Head of Operations, International Bank"
            ...
            >
              ...
              <div className="hidden md:block absolute -left-6 bottom-10 rounded-2xl bg-white shadow-lg border border-slate-200 p-4 w-[260px]">
                ...
                <p className="text-sm text-slate-600 mt-2">
                  Centralize workflows, documents, and approvals into a single controlled process for commercial clients.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className=" mx-auto">
            <motion.h2 variants={fadeInUp} className="text-3xl md:text-4xl font-semibold text-slate-900">
              How One Constellation Helps Commercial Banks
            </motion.h2>
